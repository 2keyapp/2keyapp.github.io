            ...
            <div className="prose prose-base sm:prose-lg max-w-none prose-headings:font-heading prose-headings:text-navy prose-p:text-gray-600 prose-p:leading-relaxed">
              ...
              <section className="mb-12">
                ...
                <div className="space-y-6 text-gray-600 leading-relaxed">
                  <div className="space-y-4">
                    <h3 className="font-bold text-navy text-lg">2.1 Overview and Acceptance</h3>
                    <p>
                  ...
                  <div className="space-y-4 pt-4">
                    <h3 className="font-bold text-navy text-lg">2.2 Key Definitions</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {[
                        { label: "Merchant", text: "A business that creates and manages affiliate or influencer programs on the Platform and pays commissions for qualifying referrals." },
                        { label: "Affiliate", text: "An individual or entity that joins Merchant programs, promotes offers, and may earn commissions for tracked actions (such as sales or leads)." },
                        { label: "User", text: "Anyone using the Platform, including Merchants, Affiliates, or visitors." },
                        { label: "Content", text: "Any materials, links, images, text, or data you upload or transmit through the Services." },
                        { label: "Qualifying Action", text: "A sale, lead, click, or other event that a Merchant designates as commissionable and that our tracking attributes to an Affiliate." },
                        { label: "Fees", text: "Any subscription, percentage-based, or other charges payable by Merchants as shown in your account or on our pricing page." },
                      ].map((item, i) => (
                        <div key={i} className="p-4 sm:p-5 bg-gray-50 rounded-xl border border-gray-100 transition-colors hover:bg-gray-100/50">
                          <p className="text-sm leading-relaxed"><strong className="text-navy">{item.label}:</strong> {item.text}</p>
                        </div>
                      ))}
                    </div>
                  </div>
              ...
              <section className="mb-12">
                ...
                <div className="space-y-6 text-gray-600 leading-relaxed">
                  ...
                  <div className="space-y-4 pt-4">
                    <h3 className="font-bold text-navy text-lg">3.1 Merchant Accounts</h3>
                  ...
                  <div className="space-y-4 pt-4">
                    <h3 className="font-bold text-navy text-lg">3.2 Affiliate Accounts</h3>
                  ...
                  <div className="space-y-4 pt-4">
                    <h3 className="font-bold text-navy text-lg">3.3 Account Security</h3>
              ...
              <section className="mb-12">
                ...
                <div className="space-y-6 text-gray-600 leading-relaxed">
                  ...
                  <div className="space-y-4 pt-4">
                    <h3 className="font-bold text-navy text-lg">Prohibited Activities</h3>
                  ...
                  <div className="space-y-4 pt-4">
                    <h3 className="font-bold text-navy text-lg">4.1 License to Use the Platform</h3>
              ...
              <section className="mb-12">
                ...
                <div className="space-y-6 text-gray-600 leading-relaxed">
                  <div className="space-y-4">
                    <h3 className="font-bold text-navy text-lg">5.1 Subscription Fees</h3>
                  ...
                  <div className="space-y-4">
                    <h3 className="font-bold text-navy text-lg">5.2 Billing</h3>
                  ...
                  <div className="space-y-4">
                    <h3 className="font-bold text-navy text-lg">5.3 Affiliate Payouts</h3>
                  ...
                  <div className="space-y-4">
                    <h3 className="font-bold text-navy text-lg">5.4 Taxes</h3>
                  ...
                  <div className="space-y-4">
                    <h3 className="font-bold text-navy text-lg">5.5 Refunds</h3>
              ...
              <section className="mb-12">
                ...
                <div className="space-y-6 text-gray-600 leading-relaxed">
                  ...
                  <div className="p-6 bg-gray-50 border border-gray-100 rounded-2xl text-[10px] sm:text-xs md:text-sm font-mono uppercase text-gray-600 leading-relaxed overflow-x-auto">
              ...
              <section className="mb-4">
                <h2 className="text-xl sm:text-2xl font-bold mb-6 flex items-center gap-3">
                  <span className="flex items-center justify-center w-8 h-8 rounded-lg bg-navy text-white text-sm flex-shrink-0">17</span>
                  Contact
                </h2>
                <div className="space-y-6 text-gray-600 leading-relaxed p-6 sm:p-8 bg-gray-50 rounded-2xl sm:rounded-3xl border border-gray-100">
                  <p className="text-sm sm:text-base">For questions regarding these Terms, please contact us at:</p>
                  <div className="space-y-3">
                    <p className="flex items-center gap-3 font-semibold text-navy text-sm sm:text-base">
