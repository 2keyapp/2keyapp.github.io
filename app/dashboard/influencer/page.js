  ...
  return (
    <div className="p-8 font-body max-w-7xl mx-auto">
      <div className="mb-10 flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold font-heading text-navy tracking-tight">Earnings</h1>
          <p className="text-gray-500 mt-2 text-sm">Track your commissions, generate links, and manage payouts.</p>
        </div>
      </div>

      {/* KPI Cards */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
        <div className="bg-white rounded-[24px] border border-gray-100/50 p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] relative overflow-hidden transition-all hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)]">
          <div className="relative z-10 flex flex-col h-full justify-between">
            <p className="text-[13px] font-semibold text-gray-500 mb-8">Available for Payout</p>
            <p className="text-5xl font-bold font-heading text-teal tracking-tight">$1,240.00</p>
          </div>
          <div className="absolute -bottom-4 -right-4 opacity-[0.02] transform -rotate-12">
            <Wallet className="w-48 h-48 text-navy" />
          </div>
        </div>

        <div className="bg-white rounded-[24px] border border-gray-100/50 p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] transition-all hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] flex flex-col justify-between">
          <div className="flex items-center justify-between mb-8">
            <p className="text-[13px] font-semibold text-gray-500">Pending (Net-30)</p>
            <ShieldCheck className="w-5 h-5 text-gray-300" />
          </div>
          <div>
            <p className="text-4xl font-bold font-heading text-navy tracking-tight">$845.50</p>
            <div className="mt-4">
        ...
        <div className="bg-white rounded-[24px] border border-gray-100/50 p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] transition-all hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] flex flex-col justify-between">
          <div className="flex items-center justify-between mb-8">
            <p className="text-[13px] font-semibold text-gray-500">Lifetime Earnings</p>
            <DollarSign className="w-5 h-5 text-gray-300" />
          </div>
          <div>
            <p className="text-4xl font-bold font-heading text-navy tracking-tight">$12.4k</p>
            <div className="mt-4">
              <span className="text-teal font-semibold flex items-center bg-teal/10 px-2.5 py-1 rounded-full text-xs w-max">
