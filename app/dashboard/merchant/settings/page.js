...
export default function MerchantSettingsPage() {
  return (
    <div className="p-8 max-w-5xl mx-auto font-body">
      <div className="mb-10">
        <h1 className="text-3xl font-bold font-heading text-navy tracking-tight">Settings & Billing</h1>
        <p className="text-gray-500 mt-2 text-sm">Manage your Stripe integration and core account details.</p>
      </div>
      ...
      <div className="space-y-8">
        ...
        <section className="bg-white rounded-[24px] border border-gray-100/50 shadow-[0_8px_30px_rgb(0,0,0,0.04)] overflow-hidden">
          <div className="p-8 sm:p-10">
            <h3 className="text-xl font-bold font-heading text-navy mb-6 flex items-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <div className="bg-gray-50 rounded-xl p-5 border border-gray-100 inline-block w-full">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-bold text-navy">Connection Status</p>
                      <p className="text-xs text-gray-400 font-medium tracking-wide mt-1">Not Connected</p>
                    </div>
              ...
              <div className="flex flex-col items-center justify-center p-8 bg-gray-50/50 rounded-2xl border border-dashed border-gray-300">
                <Box className="w-12 h-12 text-navy/20 mb-4" />
                <button className="bg-navy hover:bg-navy/90 text-white font-bold py-3 px-8 rounded-xl shadow-[0_8px_20px_rgb(10,25,47,0.2)] transition-all">
                  Connect with Stripe
                </button>
                <p className="text-[11px] text-gray-400 mt-4 text-center px-4 font-medium leading-relaxed">
